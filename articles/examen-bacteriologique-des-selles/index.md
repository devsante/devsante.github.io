...
Pour les Shigella\_,\_ il existe quatre sérums pour l'identification antigénique :
...
L'identification est faite par les caractères biochimiques (galerie API 20 E ou autre) *Tableau n°* 7, et par agglutination avec les sérums anti-*Vibrio cholerae* anti 0<sub>1</sub> et anti 0<sub>139</sub>, à partir de colonies repiquées sur gélose nutritive.
